...
names(mycol)<-levels(factor(stdatz.noout$ind))
plot(values~Vowel,data=stdatz.noout,xlab="Preference quotient in the Vowel task",ylab="Vocabulary (z-scored)",col=mycol[ind],pch=20)
